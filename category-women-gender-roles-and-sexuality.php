...
$the_query = new WP_Query( 'tag=feature-women-gender-roles-and-sexuality&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-women-gender-roles-and-sexuality', 'post_tag');
		$tag_id =  $tag->term_id; 

		$args = array(
			'category_name' => 'women-gender-roles-and-sexuality,family-law',
		...
		<?php
		$test_query = new WP_Query( 'page_id=8082' );
		$test_query->the_post();
		?>
