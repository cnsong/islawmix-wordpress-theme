...
$the_query = new WP_Query( 'tag=feature-islamic-law-what-it-is-and-how-it-works&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-islamic-law-what-it-is-and-how-it-works', 'post_tag');
		$tag_id =  $tag->term_id; 
		...
		<?php
		$test_query = new WP_Query( 'page_id=8101' );
		$test_query->the_post();
		?>
