...
$the_query = new WP_Query( 'tag=feature-economics-and-finance&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-economics-and-finance', 'post_tag');
		$tag_id =  $tag->term_id; 
		...
		<?php
		$test_query = new WP_Query( 'page_id=8113' );
		$test_query->the_post();
		?>
