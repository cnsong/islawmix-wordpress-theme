...
$the_query = new WP_Query( 'tag=feature-jihad-and-the-laws-of-war&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-jihad-and-the-laws-of-war', 'post_tag');
		$tag_id =  $tag->term_id; 
		...
		<?php
		$test_query = new WP_Query( 'page_id=8114' );
		$test_query->the_post();
		?>
