...
$the_query = new WP_Query( 'tag=featured-islamic-law-and-the-state&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'featured-islamic-law-and-the-state', 'post_tag');
		$tag_id =  $tag->term_id; 

		$args = array(
			'category_name' => 'islamic-law-and-the-state,islamic-constitutionalism',
		...
		<?php
		$test_query = new WP_Query( 'page_id=8111' );
		$test_query->the_post();
		?>
