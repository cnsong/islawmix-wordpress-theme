...
$the_query = new WP_Query( 'tag=feature-freedom-of-expression&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-freedom-of-expression', 'post_tag');
		$tag_id =  $tag->term_id; 
		...
		<?php
		$test_query = new WP_Query( 'page_id=8106' );
		$test_query->the_post();
		?>
