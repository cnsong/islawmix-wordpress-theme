...
$the_query = new WP_Query( 'tag=feature-culture-and-practice&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-culture-and-practice', 'post_tag');
		$tag_id =  $tag->term_id; 

		$args = array(
			'category_name' => 'culture-and-practice,food-and-drink',
		...
		<?php
		$test_query = new WP_Query( 'page_id=8118' );
		$test_query->the_post();
		?>
