...
$the_query = new WP_Query( 'tag=feature-religious-accommodation-in-the-us&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-religious-accommodation-in-the-us', 'post_tag');
		$tag_id =  $tag->term_id; 
		...
		<?php
		$test_query = new WP_Query( 'page_id=8107' );
		$test_query->the_post();
		?>
