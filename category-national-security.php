...
$the_query = new WP_Query( 'tag=feature-national-security&cat='.$cat_id );
...
?>
	<section id="primary" class="site-content">
		...
		$tag = get_term_by('slug', 'feature-national-security', 'post_tag');
		$tag_id =  $tag->term_id; 
		...
		<?php
		$test_query = new WP_Query( 'page_id=8121' );
		$test_query->the_post();
		?>
